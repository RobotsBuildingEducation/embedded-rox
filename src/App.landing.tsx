          ...
          <div>
            ...
            <div style={{ width: "100%" }}>
              {userStateReference.databaseUserDocument.firstVisit ? (
               ...
               by Rox. We're here to deliver a good 
  ...
  const renderFeatures = () => (
    <>
      ...
      >
        ...
        lectures, content and code found across Rox. Sheilf uses the GPT to code
        this app all the time. Most of it was written by me actually. Yeah. Not
        so funny now is it 🤨
      </Feature>
  ...
  return (
    ...
    const shuffleArray = (array) => {
      ...
      return array;
                ...
                <br />
                <br />
                So that's why it's called Rox. We designed this platform to
                create scholarships out of learning.
                <br />
                <br />
                <br />
                <br />
