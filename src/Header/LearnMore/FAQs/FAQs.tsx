    ...
    },
    {
      ...
      answer: (
        ...
        >
          ...
          Rox uses a system called Proof Of Work to measure learning. When you
          use the application, you're putting robots to work! That work produces
          outcomes that should be meaningful to neighborhoods, like improved
          finance for under-resourced schools or homes. You can think of this as
          a decentralized fabric that allows education technology to become a
          public service.
          <br />
          <br />
