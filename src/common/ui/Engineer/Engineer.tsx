            ...
            <SchedulerBlock hasTutorial={true}>
              ...
              <ol>
                <li style={{ padding: 6 }}>
                  ...
                  and considers intersectionality. Rox works on projects like
                  job network applications that serve the unique needs of
                  undocumented as an example.
                </li>
                <li style={{ padding: 6 }}>
            ...
            <div>
              <div>
                ...
                >
                  ...
                  Rox to create and distribute scholarships among other
                  important resources in order to assist others navigating the
                  complexities behind education.
                </div>
                <br />
