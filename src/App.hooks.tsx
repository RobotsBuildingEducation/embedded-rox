 ...
 * @param {string} depositMessage - A message to accompany the deposit, for context (default is a message about Rox Lecture).
 *
 ...
 */
export const useZap = (depositAmount = 1, depositMessage = "Rox Lecture") => {
